                    ...
                    Padding(
                      ...
                      child: FutureBuilder<ApiCallResponse>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          final listViewListItemsResponse = snapshot.data!;
                          return Builder(
                            builder: (context) {
                              final items = ListItemsCall.data(
                                    listViewListItemsResponse.jsonBody,
                                  )?.toList() ??
                                  [];
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      getJsonField(
                                                        itemsItem,
                                                        r'''$.variations[:].item_variation_data.price_money.amount''',
                                                      ).toString(),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                              ...
                                              FFButtonWidget(
                                                onPressed: () async {
                                                  _model.apiResultudt =
                                                      await OrdersCall.call();
                                                  if ((_model.apiResultudt
                                                          ?.succeeded ??
                                                      true)) {
