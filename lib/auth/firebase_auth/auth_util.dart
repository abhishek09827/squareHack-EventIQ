...
DocumentReference? get currentUserReference =>
    loggedIn ? BusinessRecord.collection.doc(currentUser!.uid) : null;

BusinessRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : BusinessRecord.getDocument(BusinessRecord.collection.doc(uid))
              .handleError((_) {}),
    )
